...
VALUES ('clvh9c4t30004356x7bandnpjZ', 'Vlastimil', 'Bureš',
       ...
       ('clvh9c4t30004356x7bandnpjY', 'Jana', 'Nováková',
        ...
        '2021-05-02 00:00:00.000', null, null),
       ('clvh9c4t30004356x7bandnpjW', 'Lukáš', 'Nový',
        '$argon2id$v=19$m=65536,t=3,p=4$dBtduH+22brzrY3Ogp+fXA$vkpdi9+F7f9Yi1kD45LCtoO1PVv8r8Rq2M0JFT0ch3o',
...
INSERT INTO `subjects` (`id`, `name`, `createdAt`, `updatedAt`, `credits`, `shortName`, `category`, `department`,
                        `guarantorId`)
VALUES ('clvh9c4t30004356x7bandnpj1', 'Programování 1', '2021-05-02 00:00:00.000', '2021-05-02 00:00:00.000', 5, 'PG1',
        'BASIC', 'KIV', 'clvh9c4t30004356x7bandnpjY'),
